...
**rev1.0 をお持ちの方は [こちら](buildguide.md) を、rev2.0 をお持ちの方は [こちら](buildguide_2.0.md) をご参照ください。**
...
* プレート類（3種類）
  * メインボード 1枚
    * 部品をハンダ付けするメインとなる基板です。コントローラボード（Keebio製 Elite-Pi）も取り付け済みです。  
...
を繰り返しながら、下の写真のように20か所全部のねじが取り付けられればOKです。  
