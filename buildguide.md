...
**このドキュメントは rev.1.0 に対応したものになります。**  
**rev1.1 をお持ちの方は [こちら](buildguide_1.1.md) を、rev2.0 をお持ちの方は [こちら](buildguide_2.0.md) をご参照ください。**
...
* ゴム足
  * 高さ10mm 2個・高さ2mm 4個（お好みで背面に貼り付けてお使いください）  
...
3. 85個のキースイッチの2ピンずつをハンダ付けする  
   ハンダ付けの際にも、もう一度スイッチが浮いていないか確認してください。  
   ![switch2](img/switch2.jpg)
    

### (7) バックプレートのねじ止め・ゴム足の取り付け
